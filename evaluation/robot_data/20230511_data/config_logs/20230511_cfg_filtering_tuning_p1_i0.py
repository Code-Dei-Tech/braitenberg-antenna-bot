...
sensorFiltering = 0 # Filtering mode for the sensors
    # 0: No filtering
    # 1: Moving average
...
offsetCorrection = False # Offset correction flag in operation
...
symPower = 0.6 # User-defined strength of correction, scale down for extreme ref sensor values
...
pidKP = 9.0 #10 # PID proportional gain
pidKI = 5.0 #7 # PID integral gain
...
sensorBaseline3Arr = [2522320854,2474151778,2485950125]
