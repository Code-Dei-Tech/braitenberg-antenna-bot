...
# Sensors
sensorLeftID = 2 # ID of the left sensor for baseline setting
sensorRightID = 3 # ID of the right sensor for baseline setting
...
sensorBaselineArray = [2556203912,2493551424,2526716324,2464388745,2588973522,2432078974,2491522551,2534316073] # Default baseline array for logging
sensorBaselineLeft = sensorBaselineArray[sensorLeftID] # Default left baseline
sensorBaselineRight = sensorBaselineArray[sensorRightID] # Default right baseline
