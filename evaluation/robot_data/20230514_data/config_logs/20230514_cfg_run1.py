...
sensorSigMax = 4000 # Maximum signal value of the sensors in PPM
...
braitenbergBehaviour = 1 # Braitenberg behaviour mode
    ...
    # 2: Love
    # 3: Exploration
braitenbergDynamic = True # Braitenberg dynamic switch
    # True: Dynamic
    # False: Simple
...
dcKI= 1200 # Dynamic Braitenberg increment signal multiplier
dcKD = 500 # Dynamic Braitenberg decrement signal multiplier
...
symPower = 2 # User-defined strength of correction, scale down for extreme ref sensor values
...
symCoeffs = [0.043687923939069395, 29.828705198354818]

# -----------------------------------------------------------------------------
# Genetic algoritm parameters
# -----------------------------------------------------------------------------
geneticAlgorithm = True # Genetic algorithm flag in operation
genTime = 5 # Time to run TUNE state in seconds
genInterval = 10 # Intervel between TUNE states in seconds
...
dcAlphaMax = 5 # Maximum DC motor multiplier
dcKSMax = 5 # Maximum simple Braitenberg instantaneous signal multiplier
dcKNMax = 5 # Maximum dynamic Braitenberg instanteous signal multiplier
...
genFitnessLower = 0.1*sensorSigMax # Lower fitness limit
genFitnessLPenalty = 0 # Penalty value for exceeding the lower fitness limit

# -----------------------------------------------------------------------------
# Path recovery parameters
# -----------------------------------------------------------------------------
pathRecovery = False # Path recovery flag in operation
pathThreshold = 0.5 # Threshold to activate path recovery (replace with decrement or variance)
pathCastSpeed = 30 # Tangential motor speed to turn when path recovery is activated in RPM
pathCastDegrees = 90 #180 # Degrees to turn when path recovery is activated
...
# pathCastPause = 2 # Pause for sensors to settle after turning in seconds
...
# -----------------------------------------------------------------------------
# MQTT configuration
enableMQTT = False # Enable MQTT-based robot control
...
sensorBaseline3Arr = [2541064572,2485686540,2508036460]
