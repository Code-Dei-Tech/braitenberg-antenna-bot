...
runTimeout = 150 # Timeout of the robot run in seconds
...
transferTime = 5 # Transfer to surge time in seconds
...
# Below coefficients are calculated in the hvClasses.py file
# filterA = 0.854 # Filter coefficient for the previous filtered value
# filterB0 = 0.0728 # Filter coefficient for the current raw value
# filterB1 = 0.0728 # Filter coefficient for the previous raw value
...
# Sensor baseline reconfiguration
baselineLeft = 2522977194 # Baseline left sensor value as u32 integer
baselineRight = 2582746029 # Baseline right sensor value as u32 integer
...
parentFolder = os.path.dirname(__file__) + "/data/" # Parent folder to organise subfolder data
...
# sensorSigNorminal = 10 # Nominal no-ethanol signal value in PPM
sensorThresholdValue = 125 # Ethanol detection threshold in PPM
...
# dcRpmRange = 70 # PWM range of the DC motor from zero to specified value
