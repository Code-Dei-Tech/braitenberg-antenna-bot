...
serialTime = 0.575 # Time between serial writing in seconds
...
sensorSigMax = 600 # Maximum signal value of the sensors in PPM
...
servoAntennaeType = 2 # Antennae type
    ...
    # 2: Sinusoidal speed
    # 3: Hopf oscillation
servoInitSpeed = 25.0 # Initial speed of the servo in RPM
...
sensorBaseline3Arr = [2447739937,2386332633,2385874848]
