...
serialTime = 0.5 # Time between serial writing in seconds
...
sensorLoops = 3 # Number of samples per serial read
sensorStorageSize = 15*sensorLoops # Number of samples to store per sensor object
sensorSigMax = 2500 # Maximum signal value of the sensors in PPM
...
dcKN = 0.33 # Dynamic Braitenberg instanteous signal multiplier
dcKI= 1 # Dynamic Braitenberg increment signal multiplier
dcKD = 0.33 # Dynamic Braitenberg decrement signal multiplier
...
servoAntennaeType = 2 # Antennae type
    ...
    # 2: Sinusoidal speed
    # 3: Hopf oscillation
servoInitSpeed = 30 # Initial speed of the servo in RPM
...
symCorrection = False # Symmetry correction flag in operation
symPower = 0.25 # User-defined strength of correction, scale down for extreme ref sensor values
...
symCoeffs = [0.25961209561687904, -5.443027085603903]
