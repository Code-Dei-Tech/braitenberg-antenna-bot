...
serialTime = 0.75 # Time between serial writing in seconds
...
sensorLoops = 4 # Number of samples per serial read
sensorStorageSize = 15*sensorLoops # Number of samples to store per sensor object
sensorSigMax = 3000 # Maximum signal value of the sensors in PPM
sensorThresholdValue = 500 # Ethanol detection threshold in PPM
...
sensorNominalRange = np.min([30,sensorStorageSize]) # Horizon of samples for nominal value averaging
...
# -----------------------------------------------------------------------------
# Symmetry correction parameters
snsCorrection = True # Symmetry correction flag in operation
...
symCoeffs = [0.011857121013335031, 29.50007748834463]
...
sensorBaseline3Arr = [2533528472,2469499702,2474613355]
