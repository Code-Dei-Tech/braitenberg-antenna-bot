...
servoDefaultLeft = servoFrontLeft # Default left servo position in microseconds
servoDefaultRight = servoFrontRight # Default right servo position in microseconds
