...
# Servo motors
servoAntennaeType = 0 # Antennae type
    # 0: Fixed position
    # 1: Fixed speed
    # 2: Sinusoidal speed
...
servoDefaultLeft = servoMiddleLeft # Default left servo position in microseconds
servoDefaultRight = servoMiddleRight # Default right servo position in microseconds
...
# 2503774270,2450427883,2467337974
# 2522320854,2474151778,2485950125
# 2563084711,2510000457,2530253164
sensorBaseline3Arr = [2563084711,2510000457,2530253164]
